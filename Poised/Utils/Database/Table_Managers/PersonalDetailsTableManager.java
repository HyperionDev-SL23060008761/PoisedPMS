 ...
 */
public class PersonalDetailsTableManager extends BaseTableManager<PersonalDetails> {

    /**
     * Constructor for PersonalDetailsTableManager.
     *
     * @param databaseManager The Database Manager that will Handle all the database Interactions.
     */
    public PersonalDetailsTableManager(DatabaseManager databaseManager) {
     ...
     */
    protected PersonalDetails buildFromQueryData(ResultSet queryResults) throws SQLException {
     ...
     */
    protected boolean itemExists(PersonalDetails personalDetails) {
    ...
    protected ArrayList<String> getProperties() {
        ...
        ArrayList<PersonalDetailsProperties> properties = PersonalDetails.getProperties();
     ...
     */
    protected ArrayList<String> getValues(PersonalDetails personalDetails) {
