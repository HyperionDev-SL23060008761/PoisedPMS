 ...
 */
public class Contractors_Table_Manager extends Base_Table_Manager<Contractor> {

    /**
     * Constructor for Contractors_Table_Manager.
     *
     * @param databaseManager The Database Manager that will Handle all the database Interactions.
     */
    public Contractors_Table_Manager(Database_Manager databaseManager) {
    ...
    protected ArrayList<String> getProperties() {
        ...
        ArrayList<Role_Properties> properties = Contractor.getProperties();
