 ...
 */
public abstract class Base_Manager <Table_Type, Table_Properties> {
    ...
    protected final Dialogue_Manager dialogueManager;
    protected final Base_Table_Manager<Table_Type> tableManager;

    //Setup the Private Properties
    private final String tableName;

    /**
     * Constructor for Base_Manager.
     *
    ...
    public Base_Manager(
            ...
            Base_Table_Manager<Table_Type> tableManager,
            String tableName
    ) {
    ...
    public void create(ActionEvent event) {
        ...
        HashMap<Table_Properties, Form_Field> formFields = getFormFields();
        ...
        Form_Dialogue<Table_Properties> formDialogue = new Form_Dialogue<>(dialogueManager);
    ...
    public void update(ActionEvent event) {
        ...
        HashMap<Table_Properties, Form_Field> filledFormFields = getFilledFormFields(selectedItem);
     ...
     */
    protected abstract HashMap<Table_Properties, Form_Field> getFilledFormFields(Table_Type item);
     ...
     */
    protected abstract HashMap<Table_Properties, Form_Field> getFormFields();
}
