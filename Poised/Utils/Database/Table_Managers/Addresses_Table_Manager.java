 ...
 */
public class Addresses_Table_Manager extends Base_Table_Manager<Address> {

    /**
     * Constructor for Addresses_Table_Manager.
     *
     * @param databaseManager The Database Manager that will Handle all the database Interactions.
     */
    public Addresses_Table_Manager(Database_Manager databaseManager) {
    ...
    protected ArrayList<String> getProperties() {
        ...
        ArrayList<Address_Properties> properties = Address.getProperties();
