 ...
 */
public class Form_Dialogue<Table_Properties> {
    ...
    public HashMap<Table_Properties, Object> showDialogue(
            ...
            HashMap<Table_Properties, Form_Field> formFields
    ) {
        ...
        Form_Field[] formFieldValues = formFields.values().toArray(Form_Field[]::new);

        //Loop through the List of Form Field Values
        for (Form_Field currentField : formFieldValues) {
            ...
            if(inputField instanceof Date_Input dateInput){
        ...
        for (int i = 0; i < formFieldValues.length; i++) {
            ...
            Form_Field currentFormFieldValue = formFieldValues[i];
            ...
            if(inputField instanceof Date_Input) {

                //Get the User's Input
                Date userInput = ((Date_Input) inputField).getSelectedDate();
