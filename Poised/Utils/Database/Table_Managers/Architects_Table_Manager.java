 ...
 */
public class Architects_Table_Manager extends Base_Table_Manager<Architect> {

    /**
     * Constructor for Architects_Table_Manager.
     *
     * @param databaseManager The Database Manager that will Handle all the database Interactions.
     */
    public Architects_Table_Manager(Database_Manager databaseManager) {
    ...
    protected Architect buildFromQueryData(ResultSet queryResults) throws SQLException {
        ...
        Personal_Details personalDetails = super.databaseManager.personalDetailsTable.findByID(personalDetailsID);
    ...
    protected ArrayList<String> getProperties() {
        ...
        ArrayList<Role_Properties> properties = Architect.getProperties();
