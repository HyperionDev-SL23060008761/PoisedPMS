...
/**
 * The Building Type Represents the Building Types Table in the Database
 */
public class BuildingType {
     ...
     */
    public BuildingType(Integer id, String buildingType){
    ...
    public String toString(boolean minimal) {
        ...
        ArrayList<BuildingTypeProperties> propertyNames = getProperties();
     ...
     */
    public static ArrayList<BuildingTypeProperties> getProperties() {

        //Setup the Properties String Array
        ArrayList<BuildingTypeProperties> properties = new ArrayList<>();

        //Add the Required Properties
        properties.addAll(Arrays.stream(BuildingTypeProperties.values()).toList());
     ...
     */
    public HashMap<BuildingTypeProperties, FormField> getFilledFormFields(DatabaseManager databaseManager) {

        //Get the List of Form Fields
        HashMap<BuildingTypeProperties, FormField> formFields = getFormFields(databaseManager);

        //Get the Input Fields for the Properties
        JTextField idInputField = ((JTextField) formFields.get(BuildingTypeProperties.id).fieldInput());
        JTextField buildingTypeInputField = ((JTextField) formFields.get(BuildingTypeProperties.Building_Type).fieldInput());
     ...
     */
    public static HashMap<BuildingTypeProperties, FormField> getFormFields(DatabaseManager databaseManager) {

        //Setup the List of Form Fields
        HashMap<BuildingTypeProperties, FormField> formFields = new HashMap<>();

        //Get the List of Properties
        ArrayList<BuildingTypeProperties> propertyList = getProperties();

        //Loop through the Requested Properties
        for (BuildingTypeProperties currentProperty : propertyList) {
