 ...
 */
public class Customers_Table_Manager extends Base_Table_Manager<Customer> {

    /**
     * Constructor for Customers_Table_Manager.
     *
     * @param databaseManager The Database Manager that will Handle all the database Interactions.
     */
    public Customers_Table_Manager(Database_Manager databaseManager) {
    ...
    protected ArrayList<String> getProperties() {
        ...
        ArrayList<Role_Properties> properties = Customer.getProperties();
