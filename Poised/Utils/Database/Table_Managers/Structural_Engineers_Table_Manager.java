 ...
 */
public class Structural_Engineers_Table_Manager extends Base_Table_Manager<Structural_Engineer> {

    /**
     * Constructor for Structural_Engineers_Table_Manager.
     *
     * @param databaseManager The Database Manager that will Handle all the database Interactions.
     */
    public Structural_Engineers_Table_Manager(Database_Manager databaseManager) {
     ...
     */
    protected Structural_Engineer buildFromQueryData(ResultSet queryResults) throws SQLException {
        ...
        Structural_Engineer newStructuralEngineer = new Structural_Engineer(structuralEngineerID, personalDetails);
     ...
     */
    protected boolean itemExists(Structural_Engineer structuralEngineer) {
    ...
    protected ArrayList<String> getProperties() {
        ...
        ArrayList<Role_Properties> properties = Structural_Engineer.getProperties();
     ...
     */
    protected ArrayList<String> getValues(Structural_Engineer structuralEngineer) {
