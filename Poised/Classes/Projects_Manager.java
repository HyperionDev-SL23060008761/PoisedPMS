...
import Poised.Utils.Dialogue.Form_Dialogue;
 ...
 */
public class Projects_Manager extends Base_Manager<Project, Project_Properties> {
    ...
    /**
     * Constructor for Projects_Manager.
     *
     ...
     */
    public Projects_Manager(Database_Manager databaseManager, Dialogue_Manager dialogueManager) {
    ...
    public void finalizeProject(ActionEvent event) {
        ...
        Select_Item_Dialogue<Project> selectProjectDialogue = new Select_Item_Dialogue<>(dialogueManager, projectList);
    ...
    protected void updateItemDetails(Project selectedItem, Project newData) {
        ...
        selectedItem.building = newData.building;
    ...
    private void find(ActionEvent event) {
        ...
        HashMap<Project_Properties, Form_Field> formFields = selectedproject.getFilledFormFields(databaseManager);

        //Setup the Form Dialogue
        Form_Dialogue<Project_Properties> formDialogue = new Form_Dialogue<>(dialogueManager);

        //Get the Updated Data from the User for this Project
        HashMap<Project_Properties, Object> projectData =
     ...
     */
    protected Project_Properties itemIDProperty() {
    ...
    protected Project getItemFromUser() {
        ...
        Select_Item_Dialogue<Project> selectItemDialogue = new Select_Item_Dialogue<>(dialogueManager, itemList);
     ...
     */
    protected Project createItemFromUserInput(HashMap<Project_Properties, Object> userInputData) {

        //Get the Project's Person Details from the User Input Data
        String projectNumber = (String) userInputData.get(Project_Properties.Project_Number);
        String name = (String) userInputData.get(Project_Properties.Name);
        Building building = (Building) userInputData.get(Project_Properties.Building_Type);
        String erfNumberString = (String) userInputData.get(Project_Properties.ERF_Number);
        Address address = (Address) userInputData.get(Project_Properties.Address);
        String totalPriceString = (String) userInputData.get(Project_Properties.Total_Price);
        String totalPaidString = (String) userInputData.get(Project_Properties.Total_Paid);
        Project_Manager projectManager = (Project_Manager) userInputData.get(Project_Properties.Project_Manager);
        Structural_Engineer structuralEngineer =
                (Structural_Engineer) userInputData.get(Project_Properties.Structural_Engineer);
        Architect architect = (Architect) userInputData.get(Project_Properties.Architect);
        Contractor contractor = (Contractor) userInputData.get(Project_Properties.Contractor);
        Customer customer = (Customer) userInputData.get(Project_Properties.Customer);
        Date deadline = (Date) userInputData.get(Project_Properties.Deadline);
        Date startDate = (Date) userInputData.get(Project_Properties.Start_Date);
        Date completionDate = (Date) userInputData.get(Project_Properties.Completion_Date);
     ...
     */
    protected HashMap<Project_Properties, Form_Field> getFilledFormFields(Project item) {
     ...
     */
    protected HashMap<Project_Properties, Form_Field> getFormFields() {
