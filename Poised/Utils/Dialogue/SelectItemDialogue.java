 ...
 */
public class SelectItemDialogue<Item_Type> {
    ...
    /**
     * Constructor for SelectItemDialogue.
     *
     ...
     */
    public SelectItemDialogue(DialogueManager dialogueManager, Item_Type[] itemList) {
