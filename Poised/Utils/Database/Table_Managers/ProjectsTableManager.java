 ...
 */
public class ProjectsTableManager extends BaseTableManager<Project> {

    /**
     * Constructor for ProjectsTableManager.
     *
     * @param databaseManager The Database Manager that will Handle all the database Interactions.
     */
    public ProjectsTableManager(DatabaseManager databaseManager) {
    ...
    protected Project buildFromQueryData(ResultSet queryResults) throws SQLException {
        ...
        //Get the Project's Building Type from the Building Type's ID
        BuildingType buildingType = super.databaseManager.buildingsTable.findByID(buildingID);
        ...
        ProjectManager projectManager = this.databaseManager.projectManagersTable.findByID(projectManagerID);
    ...
    protected ArrayList<String> getProperties() {
        ...
        ArrayList<ProjectProperties> properties = Project.getProperties();
