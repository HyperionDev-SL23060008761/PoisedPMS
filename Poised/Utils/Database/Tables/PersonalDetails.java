...
public class PersonalDetails {
     ...
     */
    public PersonalDetails(Integer id, String name, String phoneNumber, String email, Address address){
    ...
    public String toString(boolean minimal) {
        ...
        ArrayList<PersonalDetailsProperties> propertyNames = getProperties();
     ...
     */
    public static ArrayList<PersonalDetailsProperties> getProperties() {

        //Setup the Properties String Array
        ArrayList<PersonalDetailsProperties> properties = new ArrayList<>();

        //Add the Required Properties
        properties.addAll(Arrays.stream(PersonalDetailsProperties.values()).toList());
     ...
     */
    public HashMap<PersonalDetailsProperties, FormField> getFilledFormFields(DatabaseManager databaseManager) {

        //Get the List of Form Fields
        HashMap<PersonalDetailsProperties, FormField> formFields = getFormFields(databaseManager);

        //Get the Input Fields for the Properties
        JTextField idInputField = ((JTextField) formFields.get(PersonalDetailsProperties.id).fieldInput());
        JTextField nameInputField = ((JTextField) formFields.get(PersonalDetailsProperties.Name).fieldInput());
        JTextField phoneNumberInputField =
                ((JTextField) formFields.get(PersonalDetailsProperties.Phone_Number).fieldInput());
        JTextField emailInputField = ((JTextField) formFields.get(PersonalDetailsProperties.Email).fieldInput());
        JComboBox<Address> addressInputField =
                ((JComboBox<Address>) formFields.get(PersonalDetailsProperties.Address).fieldInput());
     ...
     */
    public static HashMap<PersonalDetailsProperties, FormField> getFormFields(DatabaseManager databaseManager) {

        //Setup the List of Form Fields
        HashMap<PersonalDetailsProperties, FormField> formFields = new HashMap<>();

        //Get the List of Properties
        ArrayList<PersonalDetailsProperties> propertyList = getProperties();
        ...
        for (PersonalDetailsProperties currentProperty : propertyList) {
            ...
            if(currentProperty.equals(PersonalDetailsProperties.Address)) inputField = addressSelectBox;
